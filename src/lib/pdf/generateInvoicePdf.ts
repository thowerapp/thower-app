...
/** Génère et déclenche le téléchargement du PDF de facture pour une transaction. */
export async function generateInvoicePdf(transaction: Transaction): Promise<void> {
