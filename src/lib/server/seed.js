...
async function main() {
	...
	const discoveryDefs = [
		...
		{ category: 'MOTIVATION', title: 'Bienvenue dans le programme', cloudflareUid: 'local:/jour 1/motivation jour 1.mp4', thumbnailUrl: '/jour 1/Motivation jour 1-Couverture.jpg', order: 0, unlockThreshold: 0, tags: ['seed', 'jour1'], active: true, status: 'ready' },
