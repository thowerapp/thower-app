...
/** Rappel quotidien à 10h et 19h Paris (appelé par Vercel Cron). Test : GET /api/cron/daily-notification */
export const GET: RequestHandler = async () => {
	...
	const payload = {
		title: 'Thower',
		body: 'Il est temps de vous connecter et de suivre votre programme',
		url: '/user'
	};
