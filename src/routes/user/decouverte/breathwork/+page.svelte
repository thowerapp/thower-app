<script lang="ts">
	...
	onMount(() => fireNewlyUnlocked('thower_locked_breathwork', videos));
...
<div class="media-grid">
	{#each videos as video (video.id)}
		...
		{:else}
			<a href="/user/decouverte/breathwork/{video.id}" class="mcell" class:done={video.completed} data-vid-id={video.id}>
				{#if video.completed}
