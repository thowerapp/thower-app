...
<div class="player-wrap">
	{#if video.isLocal && video.videoSrc}
		...
		></video>
	{:else}
		<div class="no-player">Vidéo non disponible.</div>
	{/if}
</div>
...
{:else}
	<p class="watch-hint">La vidéo sera marquée comme regardée à la fin de la lecture.</p>
{/if}
...
.no-player { padding:40px 18px; text-align:center; color:var(--txd); font-size:.75rem; font-family:var(--fb); }
